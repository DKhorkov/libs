...
//
//	mockgen -source=interfaces.go -destination=mocks/pool.go -package=mocks -exclude_interfaces=Connector,Transaction,Connection,Pool
//
...
func (m *MockUnitOfWork) Do(ctx context.Context, fn func(context.Context, postgresql.Transaction) error) error {
	m.ctrl.T.Helper()
